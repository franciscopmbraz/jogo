...
public class CarrotBlockType extends VoxelBlockType {
    public CarrotBlockType() {super(VoxelPalette.CARROT_ID,"terra plantada");
    }
    ...
    public Material getMaterial(AssetManager assetManager) {
        ...
        Texture tex = assetManager.loadTexture("Textures/Cenoura.png");
    ...
    public jogo.gameobject.item.Item getCustomDrop() {
        return new jogo.gameobject.item.CenouraItem(5);
    }
