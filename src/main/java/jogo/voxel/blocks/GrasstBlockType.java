...
public class GrasstBlockType extends VoxelBlockType {
    public GrasstBlockType() {
        super(VoxelPalette.GRASS_ID,"relva");
    }
    ...
    public Material getMaterial(AssetManager assetManager) {
        ...
        Texture tex = assetManager.loadTexture("Textures/Grass.png");
