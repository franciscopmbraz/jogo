...
public class WoodPlankType extends VoxelBlockType {
    public WoodPlankType() {super(VoxelPalette.WOODPLANK_ID,"troncop");
    }
    ...
    public Material getMaterial(AssetManager assetManager) {
        ...
        Texture tex = assetManager.loadTexture("Textures/WoodPlank.png");
